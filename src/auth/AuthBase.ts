...
import { OfficialAPIAuth, UnofficialProxyAPIAuth } from './'

export abstract class AuthBase {
  public isOfficialAPIAuth (): this is OfficialAPIAuth {
    return this instanceof OfficialAPIAuth
  }

  public isUnofficialProxyAPIAuth (): this is UnofficialProxyAPIAuth {
    return this instanceof UnofficialProxyAPIAuth
  }
}
